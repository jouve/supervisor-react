...
import { XmlRpcValue, XmlRpcStruct } from "./XmlRpcTypes";
...
export class Deserializer {
  ...
  constructor() {
    this._parser = sax.parser();
    this._parser.onopentag = this._onOpentag;
    this._parser.onclosetag = this._onClosetag;
    this._parser.ontext = this._onText;
    this._parser.oncdata = this._onCDATA;
    this._parser.onend = this._onDone;
    this._parser.onerror = this._onError;
  }
